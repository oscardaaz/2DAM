...
public class Main {
    public static void main(String[] args) {
        ...
        int idGenerado1 = alumnoDAO.insertarAlumno(new Alumno("Melvin","ASIR"));
        System.out.println(idGenerado1 != -1 ? "id 1 = " + idGenerado1 : "Error");
        int idGenerado2 = alumnoDAO.insertarAlumno(new Alumno("Pedro","DAM"));
        System.out.println(idGenerado1 != -1 ? "id 2 = " + idGenerado2 : "Error");
